...
(function() {
  var _op, _val, all_types, augment, augment_and_filter_request, build_file_view, cmp, delete_button, die, doValidityCheck, do_request, do_slack_request, fields, filterPost, filterPre, generate_request, generate_where_row, generic_valid_text, getID, global_files, hash_filter, op_all, op_bool, op_cmp, op_no_regex, op_nocmp, operator_names, params, redir_submit_link, selectrowsEventHandler, toBool, toBytes;
